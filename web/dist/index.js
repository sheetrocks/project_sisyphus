...
(0, _axiosDefault.default).defaults.baseURL = `https://sheet.rocks/workbook/${"tqAyj9TgxBjwlW9"}/webhooks/authenticated`;
...
class App extends (0, _react.Component) {
    ...
    async getTasks() {
        ...
        let res = await (0, _axiosDefault.default).get(`/task`);
    ...
    async addTasks(e) {
        ...
        // send to server
        await (0, _axiosDefault.default).post(`/task`, {
    ...
    async toggleTask(task) {
        ...
        await (0, _axiosDefault.default).patch(`/task?taskID=${task.id}`);
        this.getTasks();
    }
    async clearTasks() {
        // optimistic update
        ...
        await (0, _axiosDefault.default).delete(`/task`);
        this.getTasks();
    }
    render() {
        return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", {
            className: "todo-app"
        }, /*#__PURE__*/ (0, _reactDefault.default).createElement("h1", null, "To Do:"), /*#__PURE__*/ (0, _reactDefault.default).createElement("a", {
            className: "start-over",
            onClick: this.clearTasks
        }, "Start Over"), /*#__PURE__*/ (0, _reactDefault.default).createElement("table", {
            className: "task-list"
        }, /*#__PURE__*/ (0, _reactDefault.default).createElement("tbody", null, this.state.tasks.map((task)=>/*#__PURE__*/ (0, _reactDefault.default).createElement("tr", {
                className: `task ${task.completed && "completed"} ${task.newlyGenerated && "animate__animated animate__bounceInUp"}`
            }, /*#__PURE__*/ (0, _reactDefault.default).createElement("td", null, /*#__PURE__*/ (0, _reactDefault.default).createElement("input", {
                type: "checkbox",
                checked: task.completed,
                onChange: ()=>this.toggleTask(task)
            })), /*#__PURE__*/ (0, _reactDefault.default).createElement("td", null, task.text))))), /*#__PURE__*/ (0, _reactDefault.default).createElement("form", {
            className: "add-task",
...
},{"react":"efHxB","react-dom":"b1j47","axios":"8dDug","@parcel/transformer-js/src/esmodule-helpers.js":"iu2ZB"}],"efHxB":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"iu2ZB"}]},["cPee7"], "cPee7", "parcelRequire6528")
